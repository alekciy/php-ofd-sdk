...
class Check implements DocumentInterface
{
	...
	/** @var string Дата и время формирования фискального документа (во временной зоне ККТ) */
	public $createAt;

	/** @var integer|float ИТОГ, включая размер НДС и наценки */
	public $total;

	/** @var array Дополнительный реквизит пользователя */
	public $extend;
